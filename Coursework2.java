...
public class Coursework2 extends JFrame {

    GLCanvas canvas; //Define a canvas
    ...
    public Coursework2(GLCanvas canvas) {
        this.canvas = canvas;
    }
...
//			T.LookAt(0, 0, 0, 0, 0, -1, 0, 1, 0);  	//Default
            ...
            gl.glUniformMatrix4fv(ModelView2, 1, true, T.getTransformv(), 1);
            gl.glUniformMatrix4fv(NormalTransform2, 1, true, T.getInvTransformTv(), 1);
        ...
        public void init(GLAutoDrawable drawable) {
            ...
            gl.glGenBuffers(numEBOs, EBOs,idElement);
            ...
            gl.glGenVertexArrays(2,VAOs,idPoint+1);
            ...
            gl.glGenBuffers(1, VBOs2,idBuffer);
            gl.glBindBuffer(GL_ARRAY_BUFFER, VBOs2[idBuffer]);
            ...
            gl.glBufferData(GL_ARRAY_BUFFER, vertexSize2 +normalSize2,
                    null, GL_DYNAMIC_DRAW); // pay attention to *Float.SIZE/8
            ...
            program = shaderproc2.getProgram();
            gl.glUseProgram(program);
            ...
            float [] vertexArray3 = object2.getVertices();
            float [] normalArray3 = object2.getNormals();
            int [] vertexIndexs3 = object2.getIndices();
            ...
            // Initialize shader lighting parameters
            float[] lightPosition3 = {1.0f, 1.0f, 1.0f, 1.0f};
            Vec4 lightAmbient3 = new Vec4(2.0f, 2.0f, 2.0f, 2.0f);
            Vec4 lightDiffuse3 = new Vec4(2.0f, 2.0f, 2.0f, 2.0f);
            Vec4 lightSpecular3 = new Vec4(2.0f, 2.0f, 2.0f, 2.0f);
